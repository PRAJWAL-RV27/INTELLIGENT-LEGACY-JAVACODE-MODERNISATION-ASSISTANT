...
class NamingContextExtPackageTransformer:
    """
    Transformer for:
    ...
    IMPORT_PATTERN = re.compile(
        r'^\s*import\s+org\.omg\.CosNaming\.NamingContextExtPackage\.([A-Za-z_][A-Za-z0-9_]*)\s*;',
        re.MULTILINE
    )
    ...
    def transform(self, content: str):
        ...
        for match in reversed(matches):
            ...
            replacement = (
                "// ==========================================================\n"
                "// TODO(Java21)\n"
                "// org.omg.CosNaming.NamingContextExtPackage removed in Java 11.\n"
            ...
            changes.append(
                f"Removed NamingContextExtPackage import '{class_name}'."
            )
