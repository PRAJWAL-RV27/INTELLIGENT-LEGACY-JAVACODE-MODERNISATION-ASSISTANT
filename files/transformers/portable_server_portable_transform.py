...
class PortableServerPortableTransformer:
    """
    Transformer for:
    ...
    IMPORT_PATTERN = re.compile(
        r'^\s*import\s+org\.omg\.PortableServer\.portable\.([A-Za-z_][A-Za-z0-9_]*)\s*;',
        re.MULTILINE
    )
    ...
    def transform(self, content: str):
        ...
        for match in reversed(matches):
            ...
            replacement = (
                "// ==========================================================\n"
                "// TODO(Java21)\n"
                "// org.omg.PortableServer.portable removed in Java 11.\n"
            ...
            changes.append(
                f"Removed PortableServer.portable import '{class_name}'."
            )
        ...
        for class_name in imported_classes:
            ...
            for occurrence in usage_pattern.finditer(content):
                ...
                # Ignore comments inserted by this transformer
