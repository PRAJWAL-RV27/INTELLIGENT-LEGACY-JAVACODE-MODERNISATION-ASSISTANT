...
class OMGJMXRMIStubTransformer:
    """
    Transformer for:

        import org.omg.stub.javax.management.remote.rmi.*

    Removed from JDK in Java 11 (JEP 320).
    """

    IMPORT_PATTERN = re.compile(
        r'^\s*import\s+org\.omg\.stub\.javax\.management\.remote\.rmi\.([A-Za-z_][A-Za-z0-9_]*)\s*;',
        re.MULTILINE
    )
    ...
    def transform(self, content: str):
        ...
        for match in reversed(matches):
            ...
            replacement = (
                "// ==========================================================\n"
                "// TODO(Java21)\n"
                "// CORBA JMX RMI Stub removed in Java 11.\n"
            ...
            changes.append(
                f"Removed deprecated CORBA JMX stub import '{class_name}'."
            )
        ...
        for class_name in imported_classes:
            ...
            for occurrence in usage_pattern.finditer(content):
                ...
                # Ignore comments inserted by transformer
