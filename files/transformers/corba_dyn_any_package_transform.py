...
class CORBADynAnyPackageTransformer:
    """
    Transformer for:
    ...
    IMPORT_PATTERN = re.compile(
        r'^\s*import\s+org\.omg\.CORBA\.DynAnyPackage\.([A-Za-z_][A-Za-z0-9_]*)\s*;',
        re.MULTILINE
    )
    ...
    def transform(self, content: str):
        ...
        for match in reversed(matches):
            ...
            replacement = (
                "// ==========================================================\n"
                "// TODO(Java21)\n"
                "// org.omg.CORBA.DynAnyPackage removed in Java 11.\n"
            ...
            changes.append(
                f"Removed  CORBA.DynAnyPackage import '{class_name}'."
            )
