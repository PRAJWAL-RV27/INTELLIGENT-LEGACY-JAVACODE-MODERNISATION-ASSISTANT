...
class ColorModelFinalizeTransformer(BaseTransformer):
    ...
    def transform(self, content: str):
        ...
        # Only handle ColorModel subclasses
        ...
        body = re.sub(r"@Override\s*", "", body).strip()
        ...
        if cls:
            ...
            if "AutoCloseable" not in declaration:
                ...
                before_brace = declaration[:declaration.rfind("{")].rstrip()
                ...
                changes.append("Added AutoCloseable to ColorModel class.")

        changes.append("Converted ColorModel.finalize() to close().")
