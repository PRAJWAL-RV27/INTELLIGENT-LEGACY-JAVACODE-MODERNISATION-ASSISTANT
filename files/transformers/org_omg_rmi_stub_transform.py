...
class OMGRMIStubTransformer:
    ...
    IMPORT_PATTERN = re.compile(
        r'^\s*import\s+org\.omg\.stub\.java\.rmi\.([A-Za-z_][A-Za-z0-9_]*)\s*;',
        re.MULTILINE
    )
    ...
    def transform(self, content: str):
        ...
        for match in reversed(matches):
            ...
            replacement = (
                "// ==========================================================\n"
                "// TODO(Java21)\n"
                "// CORBA (org.omg.stub.java.rmi) was removed in Java 11.\n"
            ...
            changes.append(
                f"Removed deprecated CORBA import '{class_name}'."
            )
