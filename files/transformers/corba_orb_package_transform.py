...
class CORBAORBPackageTransformer:
    """
    Transformer for:
    ...
    IMPORT_PATTERN = re.compile(
        r'^\s*import\s+org\.omg\.CORBA\.ORBPackage\.([A-Za-z_][A-Za-z0-9_]*)\s*;',
        re.MULTILINE
    )
    ...
    def transform(self, content: str):
        ...
        for match in reversed(matches):
            ...
            replacement = (
                "// ==========================================================\n"
                "// TODO(Java21)\n"
                "// org.omg.CORBA.ORBPackage removed in Java 11.\n"
            ...
            changes.append(
                f"Removed  CORBA.ORBPackage import '{class_name}'."
            )
