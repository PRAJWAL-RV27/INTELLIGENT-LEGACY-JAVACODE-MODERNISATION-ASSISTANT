...
class JAXWSWSAddressingTransformer:
    """
    Transformer for:
    ...
    IMPORT_PATTERN = re.compile(
        r'^\s*import\s+javax\.xml\.ws\.wsaddressing\.([A-Za-z_][A-Za-z0-9_]*)\s*;',
        re.MULTILINE
    )
    ...
    def transform(self, content: str):
        ...
        for match in reversed(matches):
            ...
            replacement = (
                "// ==========================================================\n"
                "// TODO(Java21)\n"
                "// javax.xml.ws.spi.http removed from JDK in Java 11.\n"
            ...
            changes.append(
                f"Removed javax.xml.ws.wsaddressing import '{class_name}'."
            )
