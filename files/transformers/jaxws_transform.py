...
class JAXWSTransformer:
    ...
    IMPORT_PATTERN = re.compile(
        r'^\s*import\s+javax\.xml\.ws\.([A-Za-z_][A-Za-z0-9_]*)\s*;',
        re.MULTILINE
    )
    ...
    def transform(self, content: str):
        ...
        for match in reversed(matches):
            ...
            replacement = (
                "// ==========================================================\n"
                "// TODO(Java21)\n"
                "// javax.xml.ws removed from JDK in Java 11.\n"
                "// JEP 320 : Remove the Java EE and CORBA Modules.\n"
                "// Consider migrating to Jakarta XML Web Services (jakarta.xml.ws).\n"
            ...
            changes.append(
                f"Removed javax.xml.ws import '{class_name}'."
            )
